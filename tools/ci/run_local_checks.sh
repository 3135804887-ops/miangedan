...
echo "== 阶段1 规范校验 =="
python tools/validate_docs.py --suites required,fences,placeholders,coverage,consistency,semantics,regions,data-platform,temporal,observability,key-mgmt
